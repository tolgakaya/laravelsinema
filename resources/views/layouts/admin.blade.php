...
<head>
    ...
    <link href="/assets2/css/bootstrap-datetimepicker.css" rel="stylesheet"/>
    <!-- Morris Chart Styles-->
    <link href="/assets2/js/morris/morris-0.4.3.min.css" rel="stylesheet"/>
    <!-- Custom Styles-->
    <link href="/assets2/css/custom-styles.css" rel="stylesheet"/>
    <!-- Google Fonts-->
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="{{route('adminfilimliste')}}"><i class="fa fa-dashboard"></i> Filimler</a>
                </li>
                <li>
                    <a href="{{route('admingruplist')}}"><i class="fa fa-desktop"></i> Fiyat grupları</a>
                </li>
                <li>
                    <a href="{{route('adminsalonlist')}}"><i class="fa fa-bar-chart-o"></i> Salonlar</a>
                </li>
                <li>
                    <a href="{{route('adminseanslist')}}"><i class="fa fa-qrcode"></i>Seanslar</a>
                </li>

                <li>
                    <a href="{{route('biletlist')}}"><i class="fa fa-table"></i> Bilet Listesi</a>
                </li>
                <li>
...
<!-- Morris Chart Js -->
<script src="/assets2/js/morris/raphael-2.1.0.min.js"></script>
<script src="/assets2/js/morris/morris.js"></script>
...
<!-- Custom Js -->
<script src="/assets2/js/custom-scripts.js"></script>
