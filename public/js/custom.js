...
/*function init_Fiyatlandir() {
 ...
 if (this.value != -1) {
 var token_ = $(this).attr('data-value');
...
function init_Fiyatlandir() {
    ...
    $("#grupselect").on('change', function () {
        ...
        if (this.value != -1) {
           ...
           var  urll='/fiyat/'+grup_id;
            var dizi={'grup_id':grup_id, 'token_':token_};
            $.ajax( {
                type: 'POST',
                url: urll,
                data: dizi,
...
function init_BookingOne() {
    ...
    $(".datepicker__input").datepicker({
        ...
        onSelect: function (dateText, instance) {
            ...
            var token_ = $('input[name=_token]').val();
            var movie_id = movie.val();
            var urll = '/seans/' + movie_id + '/' + dateText;
            var dizi = {'movie_id': movie_id, 'tarih': dateText, 'token_': token_};
            $.ajax({
                type: 'POST',
                url: urll,
                data: dizi,
    ...
    $('.datepicker__input').change(function () {
        ...
        // data element set change
        date.val(chooseDate);
        // ajax call ile seansları çekecez
